...
- **Integrations** (`/integrations`) — Telegram, Stripe, Omie, Bling, Asaas, Fathom, Todoist, GitHub, Linear, Gmail, Calendar, YouTube, Instagram, LinkedIn, Evolution API, Clever AI, …
...
| Clever AI | ❌ Not needed | Reached via cross-stack HTTP over the shared Traefik network |
