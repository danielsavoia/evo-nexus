...
Guide the user through creating a new automated routine that runs on schedule via the Clever Agent scheduler.
...
- Footer: "Automatically generated by Clever Agent — Evolution Foundation"
