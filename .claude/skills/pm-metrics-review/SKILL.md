...
- MRR / ARR: monthly or annual recurring revenue (via `int-stripe`)
...
- Community sentiment from Discord (`discord-get-messages`) and WhatsApp (`int-whatsapp`)
...
- Open source instance metrics by version and region (via `int-licensing`)
