...
| `BACKUP_S3_PREFIX` | No | Folder inside the bucket (default: `clever-agent-backups/`) |
...
**No variable is strictly required** -- Clever Agent works with whatever integrations you enable. But specific routines need their corresponding keys:
